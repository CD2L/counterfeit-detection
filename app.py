...
from pipeline.models_pipeline import *
from pipeline.utils_.functions import on_image
...
ll_model = LabelLocalizationModel("./pipeline/weights/label_localization.pth","./pipeline/weights/OD_cfg.pickle")
yolo = ObjectDetectionModel("./pipeline/weights/best-yolov5x6.pt",0.2)
ocr_model = OCR()
...
def demo_processing():
    ...
    img = cv2.imread('.temp/upload/uploaded_file.jpg')
    ...
    cropped_bboxes = [crop(bbox, '.temp/upload/uploaded_file.jpg', margin=50) for bbox in bboxes]
